package com.libertymutual.goforcode.s3example.components;
...
public class AmazonS3Template {
	...
	*/
	public AmazonS3Template(@Value("${amazon.s3.default-bucket}") String defaultBucket, @Value("${amazon.aws.access-key-id}") String accessKeyId, @Value("${amazon.aws.access-key-secret}") String accessKeySecret) {
